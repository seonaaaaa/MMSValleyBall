<template>
    <div class="ticket-purchase-page">
      ...
      <!-- 티켓 안내, 티켓 구매 메뉴 -->
      <div class="menu">
        <div class="menu-item" :class="{ 'active-menu-item': activeMenu === '/ticket/info' }" @click="navigateTo('/ticket/info')">티켓 안내</div>
        <div class="menu-item" :class="{ 'active-menu-item': activeMenu === '/ticket/purchase' }" @click="navigateTo('/ticket/purchase')">티켓 구매</div>
      </div>
