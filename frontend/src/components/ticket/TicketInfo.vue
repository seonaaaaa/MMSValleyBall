    ...
    <div class="ticket-info-content">
      ...
      <div class="rule-box">
        <div>
          ...
          <div>
            - 1인 최대 4매까지 구매 가능<br>
            - 예매 오픈시간 : 경기 7일전 13시 시작<br>
            <div class="sub-text">
              * 멤버쉽 선예매는 경기 10일전 13시 시작<br>
            </div>
            - 예매 가능시간 : 경기당일 경기시작 시간 1시간 후 마감<br>
          ...
          <div>
            <h3>※ 경기 당일 안내사항</h3>
            <div>
              - 경기당일 매표소가 혼잡하오니, 모바일티켓을 활용하여 편안한 입장을 권장드립니다.<br>
